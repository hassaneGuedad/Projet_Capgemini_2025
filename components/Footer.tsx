...
export const Footer: React.FC = () => (
  <footer className="w-full bg-gray-100 border-t mt-12">
    <div className="max-w-7xl mx-auto px-4 py-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 text-sm text-gray-700">
      ...
      <div className="flex-1 flex flex-col items-center justify-start">
        <div className="flex flex-col items-start space-y-2">
          ...
          <a href="/guide" className="hover:underline">Guide d’utilisation</a>
      ...
      <div className="flex flex-col items-end md:items-end">
        <div className="flex flex-col items-start space-y-2">
          <a href="https://www.capgemini.com/accessibility/" className="hover:underline">Accessibility</a>
          <a href="https://www.capgemini.com/cookie-policy/" className="hover:underline">Cookie policy</a>
          <a href="https://www.capgemini.com/cookie-policy/#" className="hover:underline">Cookie settings</a>
          <a href="https://www.capgemini.com/privacy-notice/" className="hover:underline">Privacy notice</a>
          <a href="https://www.capgemini.com/security-vulnerability-notification/" className="hover:underline">Security vulnerability notification</a>
          <a href="#" className="hover:underline">SpeakUp</a>
          <a href="https://www.capgemini.com/terms-of-use/" className="hover:underline">Terms of use</a>
          <a href="https://www.capgemini.com/fraud-alert/" className="hover:underline">Fraud alert</a>
        </div>
      </div>
    </div>
    ...
    <div className="w-full flex flex-col md:flex-row items-center justify-between mt-4 gap-4 md:gap-0 px-4">
      {/* Copyright */}
      <div className="text-sm text-gray-500 order-2 md:order-1 text-center md:text-left">© Capgemini, 2025. All rights reserved.</div>
      {/* Réseaux sociaux */}
